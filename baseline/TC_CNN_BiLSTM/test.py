...
CONFIG = {
    # 1. 基础配置
    'model_path': 'TC_CNN_BiLSTM/results/tc_cnn_bilstm.pth',
    'scaler_path': 'TC_CNN_BiLSTM/results/global_scalers.pkl',
    'test_set_path': 'TC_CNN_BiLSTM/results/test_set_balanced.pt', 
    'output_dir': 'TC_CNN_BiLSTM/test_results',
