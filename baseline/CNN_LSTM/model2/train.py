...
CONFIG = {
    'csv_paths': [
        '../../dataset/berlin1_potsdamer_platz/RXM-RAWX_processed.csv',
        '../../dataset/berlin2_gendarmenmarkt/RXM-RAWX_processed.csv',
        '../../dataset/frankfurt1_maintower/RXM-RAWX_processed.csv',
        '../../dataset/frankfurt2_westendtower/RXM-RAWX_processed.csv'
    ],
    'output_dir': 'results',
...
class Visualizer:
    ...
    def plot_feature_importance(model, loader, criterion, device, feature_names, save_path):
        ...
        sns.barplot(x=values, y=names, palette='viridis', hue=names, legend=False)
