...
CONFIG = {
    # 1. 基础配置
    'model_path': 'CNN_Attention_BiLSTM/results/nlos_model_balanced.pth',
    'scaler_path': 'CNN_Attention_BiLSTM/results/global_scalers.pkl',
    'test_set_path': 'CNN_Attention_BiLSTM/results/test_set_balanced.pt', 
    'output_dir': 'CNN_Attention_BiLSTM/test_results',
    'log_file': 'test_report.txt', # 新增：日志文件
    
    # 2. 可视化配置
    'viz_csv_path': 'D:/3_document/4_research/smartLoc/dataset/berlin1_potsdamer_platz/RXM-RAWX_processed.csv', 
