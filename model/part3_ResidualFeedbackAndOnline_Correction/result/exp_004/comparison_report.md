...
| frankfurt1 | 525.2 | 596.9 | 596.9 | 596.9 | 521.9 | **Adaptive-M3** |
| frankfurt2 | 382.6 | 550.4 | 550.4 | 550.4 | 373.8 | **Adaptive-M3** |

## Method Selection Distribution

- **berlin1**: Standard-LS: 83%, Standard-LS(fallback): 10%, FG-MoG+TCN: 6%, WLS-MoG: 0%
- **berlin2**: Standard-LS: 78%, FG-MoG+TCN: 16%, Standard-LS(fallback): 4%, WLS-MoG: 1%
- **frankfurt1**: Standard-LS: 95%, Standard-LS(fallback): 3%, FG-MoG+TCN: 2%
- **frankfurt2**: Standard-LS: 80%, Standard-LS(fallback): 12%, FG-MoG+TCN: 8%
...
- **C4_Frankfurt1_adaptive_under_490m**: FAIL (CEP50=521.9m)
