# module2_localization/gat_e2e.py — GAT end-to-end positioning (stub)
# ponytail: GAT e2e needs trained model; stub returns LS fallback.
import numpy as np
from .base import LocalizationBase
from .factory import LocalizationFactory


@LocalizationFactory.register("gat_e2e")
class GATEndToEnd(LocalizationBase):
    """GAT-based end-to-end positioning. Stub — falls back to LS."""
